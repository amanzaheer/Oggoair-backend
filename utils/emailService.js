...
const sendLoginSuccessEmail = async (email, userName = '') => {
    try {
        ...
        const mailOptions = {
            from: process.env.EMAIL_USER,
            to: email,
            subject: 'You logged in successfully - Oggoair',
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                    <div style="background-color: #f8f9fa; padding: 30px; border-radius: 10px; text-align: center;">
                        <h2 style="color: #28a745; margin-bottom: 20px;">✓ Login Successful</h2>
                        <p style="color: #666; font-size: 16px; margin-bottom: 20px;">
                            ${greeting}
                        </p>
                        <p style="color: #666; font-size: 16px; margin-bottom: 30px;">
                            You have successfully logged in to your Oggoair account.
                        </p>
                        ...
                        <hr style="border: none; border-top: 1px solid #eee; margin: 30px 0;">
                        <p style="color: #999; font-size: 12px;">
                            This is an automated message from Oggoair.
                        </p>
                    </div>
                </div>
            `
