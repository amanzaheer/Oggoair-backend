...
const passengerBookingSchema = new mongoose.Schema({
    ...
    // Main contact information (from the top of the form)
    email: {
        type: String,
    ...
    // Multiple passengers can be booked at once
...
passengerBookingSchema.pre('save', function (next) {
    this.passengers.forEach(passenger => {
        ...
        const birthDate = new Date(passenger.dateOfBirth.year, passenger.dateOfBirth.month - 1, passenger.dateOfBirth.day);
...
// Instance method to calculate total passengers by type
